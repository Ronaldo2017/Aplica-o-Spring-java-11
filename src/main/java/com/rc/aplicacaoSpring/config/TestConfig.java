...
import com.rc.aplicacaoSpring.entities.Payment;
...
import com.rc.aplicacaoSpring.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//acessando a colecao de categorias/ associacao entre os objetos
		//categoria e produto
		...
		o1.setPayment(pay1);//associacao do pedido 1 com o pagamento 1
